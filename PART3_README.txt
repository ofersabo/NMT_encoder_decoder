...
I assume that the trg file of the dev dataset contains "dev" in its file name. that is how the script indicates that it should generate the attention heatmap data.
